...
def save_model(n2v_model, path_to_model):
    '''
    ...
    n2v_model.embedding_model.save_weights(path_to_model + '/weights.h5')

    with open(path_to_model + '/model.pkl', 'wb') as f:
        pickle.dump([n2v_model.dim, n2v_model.char_to_ix], f, protocol=2)
...
def load_model(path):
    ...
    :return model:  object, trained model.
    '''
    ...
    n2v_model = embeddingModel(emb_dim, char_to_ix)
    n2v_model.embedding_model.load_weights(path_to_model + '/weights.h5')
    n2v_model.embedding_model.compile(optimizer='adam', loss='mae')
...
def train_model(emb_dim, X_train, y_train, model_chars,
    ...
    '''
    Creates and trains embedding model using given training data.
    ...
    :return n2v_model: embeddingModel object, trained model.
    '''
    ...
    n2v_model.fit(X_train, targets, max_epochs, patience, validation_split, batch_size)
